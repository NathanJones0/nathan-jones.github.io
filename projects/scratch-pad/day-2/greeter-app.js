...
function greeter(hour) {
    ...
    // Create an if statement that will log 'Good Morning!' to the console if the hour is between 0-11
    if (hour >= 0 && hour <= 11){
        console.log('Good Morning!')
    } 
    // create an else if statement that will log 'Good Afternoon!' to the console if hour is between 12-16
    else if (hour >= 12 && hour <= 16){
        console.log('Good Afternoon!')
    }
    // create an else if statement that will log 'Good Evening!' to the console if hour is between 17-21
    else if (hour >= 17 && hour <= 21){
        console.log('Good Evening!')
    }
    //create an else if statement that will log 'Good Night!' if hour is between 22-24
